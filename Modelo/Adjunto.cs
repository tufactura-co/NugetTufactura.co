...
{
    /// <summary>
    /// Permite Cargar la información de un adjunto en la lista de anexos de un documento.
    /// </summary>
    public class Adjunto
    {
        ...
        [Display(Name = "AdjuntoId Valor Calculado Internamente")]
        public string AdjuntoId { get; set; }
        
        private string b64 { get; set; }
        /// <summary>
        ...
        public string NombreArchivo
        {
            ...
            set
            {
                string temp = value;
                nombreArchivo = temp;
                Extencion = (temp.LastIndexOf(".") > 0 ? temp.Substring(temp.LastIndexOf(".")) : ".NA").ToUpper();
            }
        }
        ...
        public Adjunto()
        {
            AdjuntoId=Guid.NewGuid().ToString().ToUpper();
        }
        [Display(Name = "TamanoBytes Valor Calculado Internamente")]
        public long? TamanoBytes { get; set; }
        [Display(Name = "Extencion Valor Calculado Internamente")]
